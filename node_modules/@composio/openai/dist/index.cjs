...
__export(index_exports, {
  OpenAIProvider: () => import_core2.OpenAIProvider,
  OpenAIResponsesProvider: () => OpenAIResponsesProvider
});
module.exports = __toCommonJS(index_exports);
var import_core2 = require("@composio/core");

// src/OpenAIResponsesProvider.ts
var import_core = require("@composio/core");
var OpenAIResponsesProvider = class extends import_core.BaseNonAgenticProvider {
  name = "openai";
  strict;
  /**
   ...
   * ```
   */
  async handleToolCalls(userId, toolCalls, options, modifiers) {
    const toolOutputs = [];
   ...
   * ```
   */
  async handleResponse(userId, response, options, modifiers) {
